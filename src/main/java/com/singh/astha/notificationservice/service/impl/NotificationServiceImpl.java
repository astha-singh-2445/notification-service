...
public class NotificationServiceImpl implements NotificationService {
    ...
    public void sendNotification(NotificationRequest notificationRequest) {
        ...
        Optional<NotificationTemplate> notificationTemplateOptional =
                notificationTemplateRepository.findByTemplateId(notificationRequest.getTemplateId());
        ...
        notificationToken.getTokens().forEach(token -> {
            Map<String, Object> data = getNotificationBody(notificationRequest,
    ...
    private Map<String, Object> getNotificationBody(NotificationRequest notificationRequest, String token,
                                                    NotificationTemplate notificationTemplate) {
        Map<String, Object> data = new HashMap<>();
        Map<String, Object> message = new HashMap<>();
        Map<String, Object> notification = new HashMap<>();
        String title = StringSubstitutor.replace(notificationTemplate.getTitle(),
